...
const Home = () => {
  ...
  return (
    <>
      <section
        id="home"
        className={`${styles.heroSection} ${styles.scrollZoomInAnimation}`}
      >
        <div className={`${styles.overlay} align-content-center`}>
          ...
          <div className="container row justify-content-center align-items-center gap-3 mt-5 flex-wrap-reverse">
            <div
              className={`${styles.heroSectionDetailsContainer} col-12 col-lg-5 text-center text-lg-start`}
            >
              <p className={`${styles.hello}`}>Hello, I am</p>
              <h1 className={`${styles.myName}`}>Swastik Rana</h1>
              <p className={`${styles.role}`}>Full Stack Developer </p>
              <p className={`${styles.SkilledAtContainer}`}>
                Skilled In{" "}
              ...
              <p>
                Welcome to my portfolio, a curated collection of my professional
                journey and creative endeavors.
              </p>
            ...
            <div
              className={`${styles.heroSectionImgContainer} col-12 col-lg-5`}
            >
